export const buildButtonSelection = (mapBox) => {
  mapBox.on('idle', () => {
    ...
    if (
      !mapBox.getLayer('healthy-antennas-layer') ||
      !mapBox.getLayer('unhealthy-antennas-layer')
    ) {
      return;
    }
    ...
    toggleableLayerIds.forEach((layerId) => {
      ...
      link.onclick = function (e) {
        ...
        const visibility = mapBox.getLayoutProperty(clickedLayer, 'visibility');
        ...
        if (visibility === 'visible') {
          ...
          mapBox.setLayoutProperty(clickedLayer, 'visibility', 'visible');
        }
      };
